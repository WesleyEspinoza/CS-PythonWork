class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
        ...
        log_file.write( "pop_size:{}\t vacc_percentage:{}\t virus_name:{}\t mortality_rate:{}\t basic_repro_num:{} \n".format(pop_size, vacc_percentage, virus_name, mortality_rate, basic_repro_num))
        log_file.closed
        pass
    ...
    def log_interaction(self, person1, person2, did_infect=None,
                        ...
                        log_file.write("Infected person: {}\t random person {}\t random person got the virus {}\t did have vacc {}\t random person got {}\n".format(person1._id, person2._id, did_infect, person2_vacc, person2_sick))
                        log_file.closed
    ...
    def log_time_step(self, time_step_number):
        ...
        # event logged ends up on a separate line!
        log_file = open(self.file_name,"a")
        log_file.write("--------------------time Step {} was completed------------------------\n".format(time_step_number))
        log_file.closed
        pass
